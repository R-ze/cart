...
<div class="qq">
  ...
  <div class="you">
       ...
       <p style="font-size:15px; color:#2F4F4F;font-weight:bold;"> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp视频类商品</p>
       <p>-------------------------------------------------------------------------------------</p>
       <div  class="gm">
        请选择你想要买的视频会员.<br><br>
 <form action="<%=request.getContextPath() %>/productServlet" method="post">
_______-----------------------------------------------两年半练习生&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(11$)
 <input name="Product" type="radio" value="007" checked="checked">加入购物车<br><br>
_______-------------------------------------------------东北新说唱&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(23$)
...
_______-----------------------------------------------------XX教学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(50$)
 ...
 <input style="border: 3px solid #ccc; border-radius:8px;"  type="submit" value="ok!" onclick="myFunction()" >
    ...
    <div class="sw1"><img src="images/sp.jpg" alt="Paris" width="600" height="250"></div>
