...
<div class="qq">
  ...
  <div class="you">
       ...
       <p style="font-size:15px; color:#2F4F4F;font-weight:bold;"> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp其他类商品</p>
       <p>-------------------------------------------------------------------------------------</p>
       <div  class="gm">
 请选择你想要买的视频会员.<br><br>
 <form action="<%=request.getContextPath() %>/productServlet" method="post">
_______-----------------------------------------------------出演服&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(40$)
 <input name="Product" type="radio" value="0010" checked="checked">加入购物车<br><br>
_______-------------------------------------------------------灯光道具&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(17$)
 <input name="Product" type="radio" value="008">加入购物车<br><br>
_______--------------------------------------------------------年费会员&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(23$)
 <input name="Product" type="radio" value="009">加入购物车<br><br>
_______---------------------------------------------------------AAA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(77$)
 <input name="Product" type="radio" value="0010">加入购物车<br><br>
_______----------------------------------------------------------XXX&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(1000$)
 <input name="Product" type="radio" value="001">加入购物车<br><br>
_______-----------------------------------------------------------WWW&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(50$)
 <input name="Product" type="radio" value="003">加入购物车<br><br><br>
 请输入数量!
 ...
 <input style="border: 3px solid #ccc; border-radius:8px;"  type="submit" value="ok!" onclick="myFunction()" >
    ...
    <div class="sw1"><img src="images/qt.jpg" alt="Paris" width="600" height="250"></div>
